      ...
      <div className="w-full max-w-lg mx-auto space-y-5">
        ...
        {wallet && (
          <motion.div key={wallet.id}
            ...
            {/* Share button — triggers globe loader */}
            <motion.button
              onClick={handleShare}
              whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
              className="gold-btn w-full py-3 rounded-xl font-bold flex items-center justify-center gap-2 text-sm">
