...
export default function SendPage() {
  ...
  if (step === 3) return (
    <div className="max-w-md mx-auto text-center py-20">
      ...
      <button
        onClick={() => { setStep(1); setForm({ ...form, recipient: "", amount: "", note: "" }); }}
        ...
        <div className="rounded-2xl border p-6 space-y-5"
          ...
          <div>
            <label className="block text-xs font-bold uppercase tracking-widest mb-2"
              style={{ color: "var(--text-muted)" }}>From Wallet</label>
          ...
          <div>
            <label className="block text-xs font-bold uppercase tracking-widest mb-2"
              style={{ color: "var(--text-muted)" }}>Recipient Account / Email</label>
          ...
          <div>
            ...
            <input placeholder="What's this for?" value={form.note}
              ...
              className="vt-input w-full px-4 py-3 rounded-xl text-sm"
              style={{ borderRadius: "0.75rem" }} />
          </div>
          ...
          <motion.button
            ...
            <Send size={18} />
            Send {form.amount && selectedWallet
              ? formatCurrency(Number(form.amount), selectedWallet.currency)
              : "Money"}
            <ArrowRight size={16} />
          </motion.button>
        </div>
